...
struct BathroomLevel: levelMapProtocol {
    ...
    func generateFurniture() {
        ...
        let bathroomSink = InteractibleItem(identifier: "bathroomSink", texture: SKTexture(imageNamed: "TileSet-piaDoBanheiroFechada"), position: (x: 3, y: 2), pickableItem: plunger, unlockableItem: crowbar)
